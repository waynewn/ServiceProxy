<?php
include __DIR__.'/../../config/MailService.php';
include __DIR__.'/../../Sys/Microservice.php';
include __DIR__.'/../../Sys/Util/Email/SmtpSSL.php';
dl("swoole.so");
/**
    ...
    public function dispatch($request,$response)
    {
        ...
        switch ($request->server['request_uri']){
            case '/'.MICRO_SERVICE_MODULENAME.'/center/shutdown':
                ...
                $this->returnJsonResponse($response,array('code'=>0,'msg'=>'shutdown...'));
                break;
            //proxy 来要自己的配置文件
